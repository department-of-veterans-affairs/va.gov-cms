...
| ---- | ---------------- | ------------------------------- |
| Create a PR | ~5 minutes | ~2 hours, 20 minutes |
| Pull Request CI Tests | ~20 minutes | ~2 hours |
| [`testing/cms`](http://jenkins.vfs.va.gov/job/testing/job/cms/) Jenkins job | ~30 minutes | ~90 minutes |
| [`deploys/cms-vagov-staging`](http://jenkins.vfs.va.gov/job/deploys/job/cms-vagov-staging/) Jenkins job | ~30 minutes | ~60 minutes |
