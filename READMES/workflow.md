...
* After updating config, run `ddev composer:test:behat --tags=dst` to run just the spec tool tests. Discrepancies between code and config will be reflected in test output
