...
- Clone the repo: [github.com/department-of-veterans-affairs/va.gov-cms](https://va.ghe.com/software/va.gov-cms) (Please clone the main repo rather than forking it.)
  ```sh
