...
| Custom block type | CMS Announcement | Body | body | Text (formatted, long, with summary) |  | 1 | Textarea with a summary and counter |  |
| Custom block type | CMS Announcement | Announcement Type | field_announcement_type | List (text) | Required | 1 | Select list |  |
| Custom block type | CMS Announcement | Title | field_title | Text (plain) |  | 1 | Text field |  |
