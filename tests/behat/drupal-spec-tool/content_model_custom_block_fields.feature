...
| Custom block type | Benefit Promo | Section | field_owner | Entity reference | Required | 1 | Select list | Translatable |
| Custom block type | News Promo | Link | field_promo_link | Entity reference revisions | Required | 1 | Inline entity form - Simple | Translatable |
...
| Custom block type | News Promo | Section | field_owner | Entity reference | Required | 1 | Select list | Translatable |
