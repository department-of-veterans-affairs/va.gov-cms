...
| Content type | Full Width Alert | Heading | - | Entity Label | Required | 1 | Textfield with counter |  |
...
| Content type | Promo Banner | Link text | - | Entity Label | Required | 1 | Textfield with counter |  |
