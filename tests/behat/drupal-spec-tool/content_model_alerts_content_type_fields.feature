...
| Content type | Full Width Alert | Paths | field_target_paths | Text (plain) |  | Unlimited | Textfield | Translatable |
...
| Content type | Promo Banner | URL | field_link | Link | Required | 1 | Link | Translatable |
