...
Feature: Content model: Content Type fields
  ...
  Scenario: Fields
    Then exactly the following fields should exist for entity type node
      ...
      | Content type | Checklist | CTA component | field_buttons | Entity reference revisions | Required | 2 | Paragraphs EXPERIMENTAL | Translatable |
      | Content type | Checklist | Checklist component | field_checklist | Entity reference revisions |  | 1 | Paragraphs EXPERIMENTAL |  |
      | Content type | Checklist | Intro text | field_intro_text_limited_html | Text (formatted, long) |  | 1 | Textarea (multiple rows) with counter | Translatable |
      | Content type | Checklist | Meta description | field_description | Text (plain) | Required | 1 | Textfield | Translatable |
      | Content type | Checklist | Meta tags | field_meta_tags | Meta tags |  | 1 | Advanced meta tags form | Translatable |
      | Content type | Checklist | Meta title tag | field_meta_title | Text (plain) | Required | 1 | Textfield | Translatable |
      | Content type | Checklist | Owner | field_administration | Entity reference | Required | 1 | Autocomplete | Translatable |
