...
Feature: Content model fields
  ...
  Scenario: Fields
    Then exactly the following fields should exist
      ...
      | Content type | VA Form | Form administration | field_va_form_administration | Entity reference | Required | 1 | -- Disabled -- |  |
      | Content type | VA Form | Form name | field_va_form_name | Text (plain) | Required | 1 | Textfield |  |
      | Content type | VA Form | Form number | field_va_form_number | Text (plain) | Required | 1 | -- Disabled -- |  |
      | Content type | VA Form | Form title | field_va_form_title | Text (plain) | Required | 1 | -- Disabled -- |  |
      | Content type | VA Form | Helpful links | field_va_form_link_teasers | Entity reference revisions |  | Unlimited | Paragraphs Classic |  |
      | Content type | VA Form | Issue date | field_va_form_issue_date | Date | Required | 1 | -- Disabled -- |  |
      | Content type | VA Form | Link to form | field_va_form_url | Link | Required | 1 | -- Disabled -- |  |
      ...
      | Content type | VA Form | Number of pages | field_va_form_num_pages | Number (integer) |  | 1 | -- Disabled -- |  |
      ...
      | Content type | VA Form | Revision date | field_va_form_revision_date | Date |  | 1 | -- Disabled -- |  |
