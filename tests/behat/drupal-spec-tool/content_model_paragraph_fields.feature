...
| Paragraph type | Step | Markup | field_markup | Markup |  | 1 | Markup |  | 
| Paragraph type | Step | Select an image | field_media | Entity reference |  | 1 | Media library |  | 
| Paragraph type | Step | Full Text | field_wysiwyg | Text (formatted, long) | Required | 1 | Textarea (multiple rows) with counter | Translatable | 
| Paragraph type | Step by step | Add Step | field_add_step | Entity reference revisions |  | 1 | Paragraphs Classic | Translatable | 
