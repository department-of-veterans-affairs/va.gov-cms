...
| Paragraph type | Accordion group | Accordion Items | field_va_paragraphs | Entity reference revisions | Required | Unlimited | Paragraphs Legacy | Translatable |
...
| Paragraph type | Accordion Item | Content block(s) | field_va_paragraphs | Entity reference revisions |  | Unlimited | Paragraphs (stable) | Translatable |
...
| Paragraph type | Alert | Alert content | field_va_paragraphs | Entity reference revisions |  | Unlimited | Paragraphs (stable) | Translatable |
...
| Paragraph type | Call to action | Button Label | field_button_label | Text (plain) | Required | 1 | Textfield with counter |  |
| Paragraph type | Call to action | Button Link | field_button_link | Link | Required | 1 | Linkit |  |
...
| Paragraph type | Checklist | Checklist sections | field_checklist_sections | Entity reference revisions |  | Unlimited | Paragraphs (stable) |  |
...
| Paragraph type | Contact information | Additional contact | field_additional_contact | Entity reference revisions |  | 1 | Paragraphs Legacy |  |
...
| Paragraph type | List of link teasers | Link teasers | field_va_paragraphs | Entity reference revisions | Required | Unlimited | Paragraphs Legacy | Translatable |
...
| Paragraph type | Lists of links | List of links | field_va_paragraphs | Entity reference revisions |  | Unlimited | Paragraphs (stable) | Translatable |
...
| Paragraph type | Non-reusable Alert | Alert Content | field_va_paragraphs | Entity reference revisions |  | Unlimited | Paragraphs (stable) | Translatable |
...
| Paragraph type | Q&A | Answer | field_answer | Entity reference revisions | Required | Unlimited | Paragraphs (stable) |  |
