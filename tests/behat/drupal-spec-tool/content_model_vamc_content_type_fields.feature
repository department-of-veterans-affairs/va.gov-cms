...
| Content type | Event | Location type | field_location_type | List (text) | Required | 1 | Select list |  |
...
| Content type | Story | Featured | field_featured | Boolean | Required | 1 | Single on/off checkbox |  |
