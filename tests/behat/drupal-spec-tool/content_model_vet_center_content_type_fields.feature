...
| Content type | Vet Center | Non-traditional hours | field_cc_non_traditional_hours | Entity Field Fetch field |  | 1 | Entity Field Fetch widget |  |
...
| Content type | Vet Center | Vet Center call center | field_cc_vet_center_call_center | Entity Field Fetch field |  | 1 | Entity Field Fetch widget |  |
