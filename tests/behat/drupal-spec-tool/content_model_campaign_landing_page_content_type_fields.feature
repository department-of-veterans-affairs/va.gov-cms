...
| Content type | Campaign Landing Page | Add Connect with us block | field_related_office | Entity reference |  | 1 | Select list | Translatable |
...
| Content type | Campaign Landing Page | Add a link to more FAQs | field_clp_faq_cta | Entity reference revisions |  | 1 | Paragraphs (stable) |  |
| Content type | Campaign Landing Page | Add a link to more videos | field_clp_video_panel_more_video | Entity reference revisions |  | 1 | Paragraphs (stable) |  |
| Content type | Campaign Landing Page | Select up to 3 audiences | field_clp_audience | Entity reference |  | 3 | Entity browser |  |
| Content type | Campaign Landing Page | Add between 3 and 10 Q&As | field_clp_faq_paragraphs | Entity reference revisions |  | Unlimited | Paragraphs (stable) |  |
| Content type | Campaign Landing Page | Downloadable resources cta | field_clp_resources_cta | Entity reference revisions |  | 1 | Paragraphs (stable) |  |
...
| Content type | Campaign Landing Page | Links with summaries | field_clp_spotlight_link_teasers | Entity reference revisions |  | Unlimited | Paragraphs (stable) |  |
| Content type | Campaign Landing Page | Optional Spotlight cta | field_clp_spotlight_cta | Entity reference revisions |  | 1 | Paragraphs (stable) |  |
