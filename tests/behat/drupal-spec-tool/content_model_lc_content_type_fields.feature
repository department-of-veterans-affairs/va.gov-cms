...
| Content type | FAQ - multiple Q&As | Calls to action | field_buttons | Entity reference revisions |  | 2 | Paragraphs Legacy | Translatable |
...
| Content type | FAQ - multiple Q&As | Need more help? | field_contact_information | Entity reference revisions |  | 1 | Paragraphs Legacy | Translatable |
...
| Content type | FAQ - multiple Q&As | Related Information | field_related_information | Entity reference revisions |  | 5 | Paragraphs (stable) | Translatable |
| Content type | FAQ - multiple Q&As | Repeat CTA buttons | field_buttons_repeat | Boolean |  | 1 | Single on/off checkbox | Translatable |
| Content type | FAQ - multiple Q&As | Q&A groups | field_q_a_groups | Entity reference revisions | Required | Unlimited | Paragraphs Legacy |  |
...
| Content type | Media list - Images | Tags | field_tags | Entity reference revisions |  | 1 | Paragraphs Legacy |  |
| Content type | Media list - Images | Alert | field_alert_single | Entity reference revisions | Required | 1 | Paragraphs Legacy | Translatable |
| Content type | Media list - Images | Calls to action | field_buttons | Entity reference revisions |  | 2 | Paragraphs (stable) | Translatable |
...
| Content type | Media list - Images | Need more help? | field_contact_information | Entity reference revisions |  | 1 | Paragraphs Legacy | Translatable |
| Content type | Media list - Images | Media list - Images | field_media_list_images | Entity reference revisions |  | 1 | Paragraphs (stable) |  |
...
| Content type | Media list - Images | Related Information | field_related_information | Entity reference revisions |  | 5 | Paragraphs (stable) | Translatable |
...
| Content type | Media list - Videos | Tags | field_tags | Entity reference revisions |  | 1 | Paragraphs Legacy |  |
| Content type | Media list - Videos | Alert | field_alert_single | Entity reference revisions | Required | 1 | Paragraphs Legacy |  |
| Content type | Media list - Videos | Calls to action | field_buttons | Entity reference revisions |  | 2 | Paragraphs (stable) | Translatable |
...
| Content type | Media list - Videos | Need more help? | field_contact_information | Entity reference revisions |  | 1 | Paragraphs Legacy | Translatable |
...
| Content type | Media list - Videos | Related Information | field_related_information | Entity reference revisions |  | 5 | Paragraphs (stable) | Translatable |
| Content type | Media list - Videos | Repeat CTA buttons | field_buttons_repeat | Boolean |  | 1 | Single on/off checkbox | Translatable |
| Content type | Media list - Videos | Videos | field_media_list_videos | Entity reference revisions |  | 1 | Paragraphs (stable) |  |
...
| Content type | Q&A | Answer | field_answer | Entity reference revisions | Required | 1 | Paragraphs (stable) |  |
| Content type | Q&A | Alert | field_alert_single | Entity reference revisions | Required | 1 | Paragraphs Legacy | Translatable |
| Content type | Q&A | Need more help? | field_contact_information | Entity reference revisions |  | 1 | Paragraphs Legacy |  |
...
| Content type | Q&A | Calls to action | field_buttons | Entity reference revisions |  | 2 | Paragraphs Legacy | Translatable |
| Content type | Q&A | Section | field_administration | Entity reference | Required | 1 | Select list | Translatable |
| Content type | Q&A | Related Information | field_related_information | Entity reference revisions |  | 5 | Paragraphs (stable) | Translatable |
