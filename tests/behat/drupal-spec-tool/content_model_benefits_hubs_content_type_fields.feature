...
| Content type | Benefits Detail Page | Featured content | field_featured_content | Entity reference revisions |  | Unlimited | Paragraphs (stable) |  |
...
| Content type | Benefits Detail Page | Last Saved by an Editor | field_last_saved_by_an_editor | Timestamp |  | 1 | Datetime Timestamp |  |
...
| Content type | Benefits Detail Page | Related Links | field_related_links | Entity reference revisions |  | 1 | Paragraphs (stable) |  |
...
| Content type | Benefits Hub Landing Page | Last Saved by an Editor | field_last_saved_by_an_editor | Timestamp |  | 1 | Datetime Timestamp | Translatable |
...
| Content type | Benefits Hub Landing Page | Related Links | field_related_links | Entity reference revisions |  | 1 | Paragraphs Legacy | Translatable |
| Content type | Benefits Hub Landing Page | Add a "Connect with us" block | field_related_office | Entity reference |  | 1 | Select list |  |
| Content type | Benefits Hub Landing Page | Spokes | field_spokes | Entity reference revisions | Required | 4 | Paragraphs (stable) |  |
...
| Content type | Landing Page | Last Saved by an Editor | field_last_saved_by_an_editor | Timestamp |  | 1 | Datetime Timestamp | Translatable |
...
| Content type | Support Service | Last Saved by an Editor | field_last_saved_by_an_editor | Timestamp |  | 1 | Datetime Timestamp | Translatable |
