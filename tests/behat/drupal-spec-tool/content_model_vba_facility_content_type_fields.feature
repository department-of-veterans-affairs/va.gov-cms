...
| Content type | VBA Facility | VBA Classification | field_facility_vba_classificatio | List (text) |  | 1 | Select list |  |
| Content type | VBA Facility | Geolocation | field_geolocation | Geofield |  | 1 | Latitude/Longitude | Translatable |
| Content type | VBA Facility | Hours | field_office_hours | Office hours |  | 1 | Office hours (week) | Translatable |
