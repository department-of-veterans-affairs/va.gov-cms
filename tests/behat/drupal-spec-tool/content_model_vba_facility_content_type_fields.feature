...
| Content type | VBA Facility Service | VBA Service Description | body | Text (formatted, long, with summary) |  | 1 | Text area (multiple rows) | Translatable |
| Content type | VBA Facility Service | Section | field_administration | Entity reference |  | 1 | Select list | Translatable |
...
| Content type | VBA Facility Service | Facility | field_office | Entity reference |  | 1 | Select list | Translatable |
| Content type | VBA Facility Service | Service Name | field_service_name_and_descripti | Entity reference |  | 1 | Select list | Translatable |
