...
| Content type | VBA Facility | Page introduction | field_intro_text | Text (plain) |  | null | Text area (multiple rows) |  |
...
| Content type | VBA Facility | Non-VA location official name | field_non_va_official_name | Text (plain) |  | 1 | Text field |  |
| Content type | VBA Facility | Parent office | field_office | Entity reference |  | 1 | Select list |  |
