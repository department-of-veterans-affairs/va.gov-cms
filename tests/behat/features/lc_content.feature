...
Feature: Learning Center metatags and path aliases are correct
  In order to confirm that learning center aliases are correct
  As anyone involved in the project
  I need to confirm the path aliases are correct
  ...
  Scenario: Confirm correct metatitles and aliases for checklist nodes
    ...
    Then the url should match "/resources/test-checklist-behat"
    ...
    Then the url should match "/resources/test-media-images-behat"

    And I visit the "" page for a node with the title "Test Media Videos - BeHaT"
    Then the url should match "/resources/test-media-videos-behat"

    And I visit the "" page for a node with the title "Test Q&A - BeHaT"
    Then the url should match "/resources/test-qa-behat"

    And I visit the "" page for a node with the title "Test Step by Step - BeHaT"
    Then the url should match "/resources/test-step-by-step-behat"

    And I visit the "" page for a node with the title "Test Detail Page - BeHaT"
    Then the url should match "/resources/test-detail-page-behat"
