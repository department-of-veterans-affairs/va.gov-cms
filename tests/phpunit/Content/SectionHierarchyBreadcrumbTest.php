...
class SectionHierarchyBreadcrumbTest extends VaGovUnitTestBase {
  ...
  public function getSectionHierarchyBreadcrumbService(
    ...
    return new SectionHierarchyBreadcrumb($entityTypeManager, $linkGenerator);
  }
  ...
  /**
   * Test ::getTermHtmlLink().
   *
   * @covers ::getTermHtmlLink
   */
  public function testGetTermHtmlLink() {
    ...
    $this->assertEquals($service->getTermHtmlLink($term), '<a href="https://www.example.com/">TEST1</a>');
  }

  /**
   * Test ::getParentTermHtmlLinks().
   *
   * @covers ::getParentTermHtmlLinks
   */
  public function testGetParentTermHtmlLinks() {
    $service = $this->getSectionHierarchyBreadcrumbService();
    $termProphecy = $this->getTermProphecy(3, 'TEST', 'https://www.example.com/');
    $term = $termProphecy->reveal();
    $this->assertEquals($service->getParentTermHtmlLinks($term),[]);
  }
   ...
   * @covers ::getParentTermHtmlLinks
   */
  public function testGetParentTermHtmlLinks2() {
    $termProphecy = $this->getTermProphecy(3, 'TEST', 'https://www.example.com/');
    $term = $termProphecy->reveal();
    $terms = [
   ...
   * Test ::buildHtmlLinks().
   *
   * @covers ::buildHtmlLinks
   */
  public function testBuildHtmlLinks() {
    $termProphecy = $this->getTermProphecy(3, 'TEST', 'https://www.example.com/');
    $term = $termProphecy->reveal();
    $terms = [
    ...
    $service = $this->getSectionHierarchyBreadcrumbService($entityTypeManager);
    // Note reverse order!
    $this->assertEquals($service->buildHtmlLinks($term), [
      '<a href="https://www.example.co.uk/">TEST4</a>',
      '<a href="https://www.example.net/">TEST3</a>',
      '<a href="https://www.example.org/">TEST2</a>',
      '<a href="https://www.example.com/">TEST1</a>',
  ...
  public function testGetHtmlLinks() {
    ...
    $service = $this->getSectionHierarchyBreadcrumbService($entityTypeManager);
    // Note reverse order!
    $this->assertEquals($service->getHtmlLinks($node), [
      '<a href="https://www.example.co.uk/">TEST4</a>',
      '<a href="https://www.example.net/">TEST3</a>',
      '<a href="https://www.example.org/">TEST2</a>',
      '<a href="https://www.example.com/">TEST1</a>',
