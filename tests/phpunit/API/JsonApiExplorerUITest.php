...
class JsonApiExplorerUITest extends VaGovExistingSiteBase {
  ...
  public function testJsonApiExplorerUILoads() {
    ...
    $this->assertSession()->elementTextContains('css', '.page-title', 'OpenAPI Documentation');

    // Any further assertions would need to be done with JavaScript test bases, such as Nightwatch.
    // Or this test could be moved to Cypress.
