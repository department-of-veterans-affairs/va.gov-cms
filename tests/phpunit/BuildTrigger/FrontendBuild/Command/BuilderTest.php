...
use Drupal\va_gov_build_trigger\FrontendBuild\Command\Builder as CommandBuilder;
use Drupal\va_gov_build_trigger\FrontendBuild\Status;

/**
 * @covers \Drupal\va_gov_build_trigger\FrontendBuild\Command\Builder
 */
class BuilderTest extends UnitTestCase {
  ...
  public function testBuildCommandsGraphQl() {
    ...
    $webBuildStatus = new Status($state, $settings);
    $webBuildCommandBuilder = new CommandBuilder($settings, $webBuildStatus);
