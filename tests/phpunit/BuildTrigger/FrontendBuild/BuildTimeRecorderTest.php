 ...
 *
 * @coversDefaultClass \Drupal\va_gov_build_trigger\FrontendBuild\BuildTimeRecorder
 */
class BuildTimeRecorderTest extends EntityKernelTestBase {
  ...
  public function testRecordBuildTime() {
    $buildTimeRecorder = $this->container->get('va_gov_build_trigger.frontend_build.build_time_recorder');
