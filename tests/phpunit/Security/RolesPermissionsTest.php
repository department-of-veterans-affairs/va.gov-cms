...
class RolesPermissionsTest extends ExistingSiteBase {
  ...
  public function expectedPerms() {
    return [
      ...
      [
        'redirect_administrator',
        [
          'access administration pages',
          'administer redirect settings',
          'administer redirects',
          'administer url aliases',
          'create terms in type_of_redirect',
          'create url aliases',
          'delete terms in type_of_redirect',
          'edit terms in type_of_redirect',
          'execute entity:break_lock path_alias',
          'execute update_alias_media media',
          'execute update_alias_node node',
          'execute update_alias_taxonomy_term taxonomy_term',
          'notify of path changes',
          'view sections in toolbar',
          'view the administration theme',
        ],
