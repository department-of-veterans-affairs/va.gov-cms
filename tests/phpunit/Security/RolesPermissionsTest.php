    ...
    return [
      ...
      [
        ...
        [
          ...
          'update media',
          'use content_admin transition approve',
          'use content_admin transition archive',
          'use content_admin transition archived_published',
          'use content_admin transition create_new_draft',
          'use content_admin transition publish',
          'use content_admin transition review',
