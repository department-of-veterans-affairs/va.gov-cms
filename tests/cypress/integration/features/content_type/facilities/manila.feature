...
Scenario: Log in and create Event as a Manila editor
  ...
  And I select option "---VA Manila health care" from dropdown "Section"
  ...
  And I fill in autocomplete field with selector "#edit-field-facility-location-0-target-id" with value "Manila VA health care | Manila VA Clinic (1059)"
