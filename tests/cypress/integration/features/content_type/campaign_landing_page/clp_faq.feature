...
Feature: Content Type: Campaign Landing Page
  ...
  Scenario: Test FAQ page segment requirements
    ...
    When I click the button with selector "#edit-field-clp-reusable-q-a-0.paragraphs-dropdown-toggle"
    ...
    When I click the button with selector "#edit-field-clp-faq-paragraphs-0.paragraphs-dropdown-toggle"
    ...
    And I fill in field with selector "#edit-revision-log-0-value" with fake text
    And I save the node
    Then I should see "Campaign Landing Page"
