...
Given(
  ...
  function watchdogLogHandler(severity) {
    return cy.drupalWatchdogHasNoNewMessages(severity);
  }
);
...
Given(
  ...
  function watchdogLogHandler() {
    return cy.drupalWatchdogHasNoNewMessages("Error");
  }
);
...
Given(
  ...
  function watchdogLogHandler(count, severity) {
    return cy.drupalWatchdogHasNewMessages(severity, count);
  }
);
...
Given(
  ...
  function watchdogLogHandler(count) {
    return cy.drupalWatchdogHasNewMessages("Error", count);
  }
);
