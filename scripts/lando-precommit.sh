...
if [ ${#PHP_FILES} -gt 0 ]; then
  phpcs --ignore=*.md,*.min.css,styles.css,wysiwyg.css,proofing.css,user_guides.css,*/node_modules/*,*/simplesaml*/* --extensions=php,module,inc,install,profile,engine,theme,css --standard=./docroot/vendor/drupal/coder/coder_sniffer/Drupal/ruleset.xml --colors ${PHP_FILES[*]}
  bail_if_test_failed 
fi
