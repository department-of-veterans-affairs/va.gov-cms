...
ddev drush va-gov-cms-export-all-content --process-count=8 --entity-count=500 --delete-existing
mv docroot/sites/default/files/compare/cms-export-content compare/cms-export-content-orig
echo ""
ddev drush scr ../scripts/content/VACMS-3450-paragraphs-should-have-a-single-parent.php
ddev drush va-gov-cms-export-all-content --process-count=8 --entity-count=500 --delete-existing
