...
- [ ] **Step 3:** Whether or not the closure has been reported to VAST, if the closure is confirmed, please send the editor a link to the following KB article and ask them to complete the steps listed: https://prod.cms.va.gov/help/vamc/about-locations-content-for-vamcs/how-to-archive-a-closed-facility
