      ...
      const targets = [
        {
          selector: document.querySelectorAll(
            "ul.toolbar-menu.top-level-nav > li > a"
          ),
          event: "top-level-nav",
          subtype: false,
        },
        {
          selector: document.querySelectorAll(
            "ul.toolbar-menu.lower-level-nav li a"
          ),
        ...
        },
        {
          ...
          selector: document.querySelectorAll(
            ".views-field-edit-node a.button"
          ),
          event: "content-edit",
        ...
        },
        {
          ...
          selector: document.querySelectorAll(
            ".views-field-operations li.edit > a"
          ),
          event: "content-edit",
        ...
        {
          selector: document.querySelectorAll(
            '#edit-actions.form-actions [value="Save"]'
          ),
          event: "content-save",
          subtype: false,
        },
        ...
        {
          selector: document.querySelectorAll(
            '#edit-actions.form-actions [value="Save and continue editing"]'
          ),
        ...
        {
          selector: document.querySelectorAll(
            "#edit-actions.form-actions a.button:last-child"
          ),
