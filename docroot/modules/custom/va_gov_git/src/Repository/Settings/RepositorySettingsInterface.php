...
interface RepositorySettingsInterface {
  ...
  const NEXT_BUILD_VETS_WEBSITE = 'next-build-vets-website';
  const REPOSITORY_NAMES = [
    self::VA_GOV_CMS,
    self::CONTENT_BUILD,
    self::VETS_WEBSITE,
    self::NEXT_BUILD,
    self::NEXT_BUILD_VETS_WEBSITE,
  ];
  ...
  const NEXT_BUILD_VETS_WEBSITE_PATH_KEY = 'va_gov_next_build_vets_website_root';
  const PATH_KEYS = [
    ...
    self::NEXT_BUILD_VETS_WEBSITE => self::NEXT_BUILD_VETS_WEBSITE_PATH_KEY,
  ];
