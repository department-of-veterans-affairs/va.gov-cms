 ...
 *  id = "va_gov_warn_inactive_users_notification",
 *  label = @Translation("Sends email notifications to inactive users on VA.gov"),
 *  max_retries = 3,
 *  retry_delay = 10
 * )
 */
class InactiveUsersNotification extends JobTypeMessageNotifyBase {}
