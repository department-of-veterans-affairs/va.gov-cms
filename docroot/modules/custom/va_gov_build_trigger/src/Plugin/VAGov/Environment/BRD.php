...
class BRD extends EnvironmentPluginBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Attempt a frontend build.
   */
  public function attemptFrontendBuild(): void {
  ...
  /**
   * Report an issue that arose while attempting the frontend build.
   *
  ...
  public function triggerFrontendBuild(): void {
    try {
      $this->attemptFrontendBuild();
    }
    catch (RequestException $exception) {
      $this->reportFrontendBuild($exception);
    }
  }
   ...
   */
  private function recordBuildTime(): void {
