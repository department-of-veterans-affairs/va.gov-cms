...
/**
 * Expose a metric for time since last content release.
 *
 * @MetricsCollector(
 *   id = "va_gov_time_since_last_content_release",
 *   title = @Translation("Time since last content release"),
 *   description = @Translation("Time since last content release")
 * )
 */
class TimeSinceLastContentRelease extends BaseContentReleaseMetricsCollector {
