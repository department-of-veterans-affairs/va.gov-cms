...
class EntityEventSubscriber implements EventSubscriberInterface {
  ...
  public function modifyRecurringEventsWidgetFieldPresentation(array &$form) {
    ...
    // Change the repeat end time text to be VA relevant.
    $form['field_datetime_range_timezone']['widget'][0]['repeat-end']['#title'] = $this->t('Stop');

    unset($form['field_datetime_range_timezone']['widget'][0]['repeat']['#options']['']);
    ...
    // Hide time increment to ensure default "UNTIL" option is used.
    $form['field_datetime_range_timezone']['widget'][0]['repeat-end']['#attributes']['class'][] = 'ethan-test';
