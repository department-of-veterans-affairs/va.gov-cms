  ...
  Drupal.behaviors.smartDateRecurringInteractions = {
    attach: function attach() {
      var dateFieldHandler = function dateFieldHandler() {
        var dateFields = [document.getElementById("edit-field-datetime-range-timezone-0-value-date"), document.getElementById("edit-field-datetime-range-timezone-0-end-value-date"), document.getElementById("edit-field-datetime-range-timezone-0-repeat-end-date")];
        ...
        var limitDateRangeInputOnKeyUp = function limitDateRangeInputOnKeyUp(e) {
          ...
          if (inputDate[0] !== undefined && inputDate[1] !== undefined && inputDate[2] !== undefined && inputDate[0] >= 2 && inputDate[0] > maxyear) {
            ...
            if (e.srcElement.id === "edit-field-datetime-range-timezone-0-value-date") {
              document.getElementById("edit-field-datetime-range-timezone-0-end-value-date").value = maxyear + "-" + inputDate[1] + "-" + inputDate[2];
            }
          }
        };
