  ...
  Drupal.behaviors.smartDateRecurringInteractions = {
    attach: function attach() {
      var dateFieldHandler = function dateFieldHandler() {
        ...
        var limitDateRangeInputOnKeyUp = function limitDateRangeInputOnKeyUp(
          e
        ) {
          ...
          if (
            ...
            e.srcElement.value =
              maxyear + "-" + inputDate[1] + "-" + inputDate[2];
            if (
              e.srcElement.id ===
              "edit-field-datetime-range-timezone-0-time-wrapper-value-date"
            ) {
      ...
      var hideNoneOption = function hideNoneOption() {
        var recurringToggle = document.getElementById(
          "edit-field-datetime-range-timezone-0-make-recurring"
        );
        if (recurringToggle) {
      ...
      var recurringToggles = document.querySelectorAll(
      ...
      var wrapDisplayHandler = function wrapDisplayHandler(
        value,
        allWrapsArray,
        daysWrap,
      ...
      var recurringWatchers = function recurringWatchers() {
        ...
        recurringToggles.forEach(function (toggle) {
          ...
          var recurrenceSelectorType = document.getElementById(
