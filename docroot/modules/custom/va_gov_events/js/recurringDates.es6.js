    ...
    attach() {
      ...
      const dateFieldHandler = () => {
        const dateFields = [
          document.getElementById(
            "edit-field-datetime-range-timezone-0-value-date"
          ),
          document.getElementById(
            "edit-field-datetime-range-timezone-0-end-value-date"
          ),
          document.getElementById(
      ...
      const createFauxInstancesButton = () => {
        if (
          ...
          // const test = .outerHTML+='<p>I am the new element</p>'
      ...
      // button button--small manage-instances use-ajax
